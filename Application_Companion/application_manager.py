...
class ApplicationManager(multiprocessing.Process):
    ...
    def __convert_string_to_dictionary(self, lines):
        ...
        # NOTE as per protocol, the local minimum stepsize is received as a
    ...
    def __execute_init_command(self):
        ...
        2. Receives the local stepsize from the simulator and sends it to the
        ...
        # 2. Get minimum local stepsize from application and send to AC
    ...
    def __execute_start_command(self):
        ...
        2. Receives outputs from the application.
